...
# Current Speed
Using the Average Load Time Tester Chrome Extenstion with Force Refresh Enabled and all modules loaded: 0.095 seconds for the Load Event to End. <-- Using the grid.html example file.
